...
修改**任何 crate** 时，请先阅读该 crate 根目录及docs目录下的所有文档规范等。同时查阅**本机的/Users/liuyuan/project/liuyuan/zed目录下的Zed编辑器的源码**，看看zed是如何实现的，参考zed的实现方式，甚至是直接照搬zed的实现方式。zcv不考虑实时协作、远程操作。

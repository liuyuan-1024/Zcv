...
///
/// 同时清除 pointer selection session —— 任何通过命令系统（键盘、IME、剪贴板等）修改选区的操作
/// 都可能让 PointerSelectionSession 里残留的鼠标拖拽锚点失效。
/// TODO: 宿主可根据 [`crate::CommandOutcome::selection_changed`] 改为按需推送，
/// 减少不必要的 CancelPointerSelection。

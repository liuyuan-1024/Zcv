...
pub(super) fn math_element(latex: &str, display_mode: bool) -> AnyElement {
    let text_color = crate::theme::color::current().gray.s09;
    let ratex_color =
...
fn render_latex_to_svg(
    ...
    let body_size = crate::theme::typography::editor_font_size() as f64;
    ...
    let svg = ratex_svg::render_to_svg(
        ...
        &ratex_svg::SvgOptions {
            font_size,
            padding: if display_mode { body_size * 0.4 } else { 1.0 },

...
use crate::{
    CharOffset, CompositionSelection, CompositionState, CoordinateError, EngineResult, Selection,
...
impl Buffer {
    ...
    pub(super) fn cancel_composition_before_text_edit(&mut self) -> EngineResult<()> {

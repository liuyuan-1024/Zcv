...
// M3 testbed：必须是 M2 testbed 的 superset。
// 保留 M2 的输入 / Delete / Home / End / Save / Reset / 批量事务 / Delta / ChangeSet 可视化能力，
// 再叠加 Undo / Redo / History / Snapshot 可视化。
actions!(
    m3_testbed,
    [
        Backspace,
...
fn main() {
    Application::new().run(|cx: &mut App| {
        ...
        cx.open_window(
            ...
            |_window, cx| cx.new(|cx| M3Testbed::new(cx)),
        )
        .unwrap();

...
use crate::{
    ByteOffset, CoordinateError, Line, LineRange, TextRange, TextResult, storage::TextRead,
};
...
fn line_content_end<T: TextRead>(text: &T, full_range: TextRange) -> TextResult<ByteOffset> {
...
pub(crate) fn text_range_for_line<T: TextRead>(text: &T, line: Line) -> TextResult<TextRange> {
...
fn byte_offset_for_line_boundary<T: TextRead>(text: &T, line: Line) -> TextResult<ByteOffset> {
